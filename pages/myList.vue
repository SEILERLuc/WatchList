<template>
  <div>
    ...
    <div class="sm:mt-10 flex flex-col items-center justify-center">
      <img
        src="/img/UI/WSWWT-logo-v2.png"
        class="my-6 relative max-h-80 w-[150px] max-w-[75%]"
        alt="background"
      />
      <h1
        class="text-center text-sm font-extrabold uppercase text-red-600 mx-4 sm:mb-12 sm:text-2xl md:w-[90%]"
      >
        My list
      </h1>
    ...
    <n-modal
      ...
      preset="dialog"
      title="Dialog"
      content="Are you sure to clear the list?"
      positive-text="Clear"
    ...
    >
      <ul
        class="mb-12 mt-10 flex flex-wrap justify-center font-mono text-xs max-w-7xl"
      >
    ...
    >
      <h2
        class="color-white text-center mb-1 mt-2 py-2 text-md font-bold sm:text-3xl"
      >
        Nothing in your list.<br />
        Return to home to add shows in your wachlist !
      </h2>
    </div>
