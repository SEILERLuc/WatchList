<template>
  <div>
    ...
    <div class="sm:mt-10 flex flex-col items-center justify-center">
      ...
      />
      <img
        src="/img/UI/cinema.png"
        class="w-32 sm:w-48 mt-4 mb-10"
        alt="cinema"
      />

      <h1
        class="text-center text-sm font-extrabold uppercase text-red-600 mx-4 mb-6 sm:mb-12 sm:text-2xl md:w-[90%]"
      >
    ...
    <div class="mb-16 flex flex-col items-center">
      <TonightChoiceCard
        v-if="user.showList.length !== 0"
        :show="user.showList[randomChoice]"
      />
    </div>
    ...
    <div class="text-lg flex flex-col items-center mb-8">
      <button
        type="button"
        class="text-white bg-red hover:rotate-180 duration-400"
        @click="(randomChoice = user.chooseShow()), changeMessage()"
      >
        <img
          src="/img/UI/change-button.png"
          class="w-12 sm:w-max"
          alt="change"
        />
      </button>
